...
train_data = datasets.MNIST(
    data_save_path, train=True, download=downloaded, transform=data_transform)
...
for epoch in range(5):
    ...
    print('epoch: %d, train_loss: %.6f, val_loss: %.6f, accuracy: %.2f' %
          (epoch, loss_train, loss_val, accuracy))
